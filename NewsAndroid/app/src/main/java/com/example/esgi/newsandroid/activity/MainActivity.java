...
import com.example.esgi.newsandroid.fragment.DetailNewsFragment;
import com.example.esgi.newsandroid.fragment.DetailTopicFragment;
import com.example.esgi.newsandroid.fragment.ListCommentsFragment;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void displayListNews(){
        ...
        FragmentManager fm = getSupportFragmentManager();
        Fragment fragment = ListNewsFragment.newInstance();
        FragmentTransaction transaction = fm.beginTransaction();
        transaction.replace(R.id.fragment_activity_main, fragment);
        transaction.addToBackStack(null);
        transaction.commit();
    ...
    public void displayNewsDetails(){
        FragmentManager fm = getSupportFragmentManager();
        Fragment fragment = DetailNewsFragment.newInstance();
        FragmentTransaction transaction = fm.beginTransaction();
        transaction.replace(R.id.fragment_activity_main, fragment);
        transaction.addToBackStack(null);
        transaction.commit();
    ...
    public void displayListComment(){

        FragmentManager fm = getSupportFragmentManager();
        Fragment fragment = ListCommentsFragment.newInstance();  //Ajouter le fragment
        FragmentTransaction transaction = fm.beginTransaction();
        transaction.replace(R.id.fragment_activity_main, fragment);
        transaction.addToBackStack(null);
        transaction.commit();
